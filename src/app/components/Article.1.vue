<template>
  <article id="article" class="entry">
    ...
    <div class="entry-content">
      ...
      <p class="lead">В этом примере, <span v-text="`<share-buttons/>`"></span> будет интерпретирован браузером и "заменен" HTML разметкой,
        которую вы для него определили. В результате получим:</p>
      <Gist iframeId="e9ea19cb422c98942137e9e3db39c426" />
      <!--<iframe id="iframe" scrolling="no" style="width:100%" ref="iframe"></iframe>-->

      <p class="lead">Так же здесь можно было бы использовать JS логику, чтобы при событии click делиться страницей через Facebook
        или Twitter.
      </p>

      <p class="lead">
        <strong>Web компоненты подобны Vue.js компонентам.</strong> Они имеют жизненный цикл (lifecycle), свойства и могут
      ...
      <p class="lead">
        <strong>Проблема в том, что Web компоненты не имеют полной поддержки в браузерах до настоящего момента.</strong> Посмотреть поддержку
      ...
      <p class="lead">
        Но, применив немного JS магии <strong>вы можете прямо сейчас перевести ваши Vue.js компоненты в Web компоненты, </strong>      
        что позволит использовать их в любых web приложениях, даже вместе с React, Angular или
      ...
      <p class="lead">
        ...
        <a
          href="https://github.com/karol-f">@karol-f</a>. Она позволит вам
      ...
      <p class="lead">
        ...
        (атрибут "false" интерпретируется как boolean значение false).
      </p>
      <p class="lead">
      ...
      <p class="lead">
        ...
        <strong>Он позволяет взять код Vue.js компонента (в форме .vue файла) и на выходе получить единый .js файл</strong>
      ...
      <p class="lead">
        Замечание: <del>Итоговый файл весит 266kB.</del> Слишком большой размер файла. Мои навыки в работе с Webpack не позволили его уменьшить.
        Попытки ипользовать плагин UglifyJsPlugin привели к ошибке, которую не удалось устранить.
        Возможно, у вас получиться лучше, пожалуйста сообщите мне как можно оптимизировать мои настройки, уверен их можно улучшить.
      </p>
      ...
      <p class="lead">
        <strong>Это часть статьи не обязательна</strong> для использования Vue.js компонентов, как Web компонентов, 
      ...
      <p class="lead">
        Библиотека полифиллов позволяет вам использовать эти API в браузерах, еще не имеющих их поддержки.
        Ниже ссылки на некоторые из них:
        <ul class="disc">
          <li><a href="https://github.com/webcomponents/custom-elements">Custom Elements polyfill</a> (от команды Polymer)</li>
        ...
        их Vue.js компонентов к пользовательским элементам. Посмотрите ссылки в конце, чтобы получить больше информации по данной теме.
      </p>
      ...
      <ul class="disc">
        <li><a href="https://karol-f.github.io/vue-custom-element/">Vue Custom Element</a>: трансформация Vue.js компонентов в пользовательские элементы</li>
        <li><a href="https://github.com/kartsims/vue-customelement-bundler">Vue Custom Element Bundler</a>: сборка Vue.js компонентов в виде единого .js файла</li>
        <li><a href="https://www.webcomponents.org">WebComponents.org</a>: каталог и ресурсы по пользовательским элементам (Custom Elements)</li>
        <li>
