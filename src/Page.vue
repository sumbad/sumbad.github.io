<template>
  <section id="page" class="page">
    ...
    <p class="lead">Так же здесь можно было бы использовать JS логику для того, чтобы при событии click делиться данной страницей через Facebook
      или Twitter.
    </p>
    ...
    <p class="lead">
      <strong>Проблема. Web компоненты не имеют полной поддержки в браузерах до настоящего момента.</strong> Посмотреть поддержку
    ...
    <p class="lead">
      Этот пример использует HTML тег <span v-text="`<template>`"></span>, но вы можете поместить строку шаблона непосредственно
    ...
    <p class="lead">
      ...
      <ul class="disc">
        ...
        <li>поведение компонента понятно непосредственно из исходного кода</li>
      </ul>
    ...
    <h4>Сборка Vue.js компонентов в единый .js файл</h4>
    <p class="lead">
    ...
    <h3>Немного об API Web компонентов (Web Components API)</h3>
    ...
    <p class="lead">
      ...
      <ul class="disc">
        <li>constructor (элемент обновлен, имеется ввиду вставлен в DOM с помощью JS или изначально там находящийся)</li>
    ...
    <h3>Взаимодействие помпонентов</h3>
